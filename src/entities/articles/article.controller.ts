...
export class ArticleController {
  // GET /api/articles - PUBLIC ROUTE (only published)
  static async getAll(c: Context) {
    const articles = await ArticleService.getAll(false);
    return c.json(
      ApiResponse.success(
        articles,
  ...
  // GET /api/admin/articles - ADMIN ROUTE (all articles including unpublished)
