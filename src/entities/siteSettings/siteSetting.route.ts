...
import { SiteSettingController } from "./siteSetting.controller.ts";
...
// ADMIN ROUTES - Superadmin only
siteSettingRoutes.post("/site-settings", requireAuth, requireSuperadmin, SiteSettingController.create);
siteSettingRoutes.put("/site-settings/:id", requireAuth, requireSuperadmin, SiteSettingController.update);
siteSettingRoutes.delete("/site-settings/:id", requireAuth, requireSuperadmin, SiteSettingController.delete);
